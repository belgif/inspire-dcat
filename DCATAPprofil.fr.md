...
| dcat:dataset        | jeu de données                          | Informations relatives au(x) jeu(x) de données référencés dans le catalogue considéré               | R                               | W                            | 1-n         | dcat:Dataset        | [si catalogue généré à partir d'un CSW --> getrecords avec type = dataset <> si catalogue généré par wizard : génération a posteriori sur base des datasets renseignés](https://github.com/belgif/inspire-dcat/blob/main/DCATAPprofil.fr.md#CSW)             |
...
| foaf:homepage       | page d'acceuil                          | Version human readable du catalogue considéré                                                       | R                               | R                            | 0-1         | rdf:Description     | [Pas de XPATH : https://www.geo.be/home (ou homepage du catalogue propre à l'institution si celui-ci est harvesté)](https://www.geo.be/home)                                                                                                                 |
| dct:language        | langue                                  | Langue(s) dans le(s)quelle(s) on peut consulter le catalogue considéré                              | M                               | O                            | 4           | skos:Concept        | //\*/gmd:locale/gmd:PT_Locale/gmd:languageCode/gmd:LanguageCode/@codeListValue                                                                                                                                                                               |
...
| dct:spatial         | couverture spatiale                     | Description de la couverture spatiale des ressources comprises dans le catalogue                    | R                               | O                            | 1-n         | dct:Location        | //\*/gmd :identificationInfo/\*/gmd :extent/gmd :EX_Extent/gmd :geographicElement                                                                                                                                                                            |
...
| dct:identifier                | identifiant                             | Identifiant alphanumérique unique du jeu de données concerné                                                                                                      | M                                                | M                                 | 1           | multilingue             | //\*/gmd:identificationInfo/\*/gmd:citation/gmd:CI_Citation/gmd:identifier/\*/gmd:code/\*                                                                                                                                                                                                                                                                                                                     |
...
| dct:publisher                 | éditeur                                 | Informations relatives à l'organisation responsable de la disponibilité du jeu de données                                                                         | O                                                | W                                 | 0-n         | foaf:organization       | //\*/gmd:identificationInfo/\*/gmd:pointOfContact/gmd:CI_ResponsibleParty[gmd:role/gmd:CI_RoleCode[@codeListValue='publisher']]                                                                                                                                                                                                                                                                               |
...
| dct:rightsHolder              | ayant droits                            | Organisation détenteur de droits sur le service                                                                                                                   | O                                                | W                                 | 0-1         | foaf:Organization       | //\*/gmd:identificationInfo/\*/gmd:pointOfContact/gmd:CI_ResponsibleParty[gmd:role/gmd:CI_RoleCode[@codeListValue='user']]/gmd:organisationName                                                                                                                                                                                                                                                               |
...
| adms:representationTechnique  | type de jeu de données                  | Informations relatives à la représentation spatiale du jeu de données                                                                                             | R                                                | W                                 | 1           | skos:Concept            | //\*/gmd:identificationInfo/\*/gmd:spatialRepresentationType                                                                                                                                                                                                                                                                                                                                                  |
...
| dcat:endpointURL              | URL du service                          | URL du service considéré                                                                               | M                                                | M                                            | 0-n         | URL                 | A voir                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| dct:type                      | type de service                         | Informations relatives au type de service                                                              | R                                                | R                                            | 1           | skos:Concept        | //\*/gmd:identificationInfo/\*/srv:serviceType                                                                                                                                                                                                                                                                                                                                                                |
...
| dct:conformsTo                | système de projection géographique      | Informations relatives aux systèmes de référence spatiaux ou temporels                                 | R                                                | R                                            | 0-n         | codedValue          | //\*gmd:referenceSystemInfo/gmd:MD_ReferenceSystem/gmd:referenceSystemIdentifier/gmd:RS_Identifier/gmd:code                                                                                                                                                                                                                                                                                                   |
...
| adms:status         | statut                             | Informations relatives à la maturité de la distribution                                | O        | 1           | skos:Concept          | pas de XPATH spécifié                     |
...
| vcard:hasURL            | dite web        | Site web de l’organisation                                | R        | 1-4         | rdf:Description | ./gmd:contactInfo/gmd:CI\_Contact/gmd:onlineResource/gmd:CI\_OnlineResource/gmd:linkage |
