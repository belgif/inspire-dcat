...
| dct:issued          | date de première publication            | Date de première publication du catalogue                                                           | R        | 0-1         | date (YYYY-MM-DD)   | //\*/gmd:identificationInfo/\*/gmd:citation/gmd:CI\_Citation/gmd:date/gmd:CI\_Date\[gmd:dateType/gmd:CI\_DateTypeCode\[@codeListValue='publication'\]\]/gmd:date                          |
...
| dct:isPartOf        | catalogue incluant                      | Informations relatives au(x) catalogue(s) comprenant dans le catalogue considéré                    | O        | 0-n         | dcat:Catalog        | si catalogue généré à parti’ d'un [CSW](#CSW) --> ID du catalogue de BOSA + ID du catalogue suprême DCAT de l'IGN <> si catalogue généré par wizard : prévoir champ                       |
...
| foaf:homepage      | page d'acceuil                          | Version human readable du catalogue considéré                                                       | R        | 0-1         | URL multilingue    | Pas de XPATH : ht tps://www.geo.be/home (ou homepage du catalogue propre ’ l'institution si celui-ci est harvesté)                                                       |
...
| dcat:landingPage              | page d'accueil                          | Page de métadonnées HTML d’origine                                                                     | R        | 0-4         | rdf:Description         | https://www.geo.be/catalog/details/ + //\*/gmd:fileIdentifier                                                                                                                                                                                                                                                                                                                                                         |
...
| dct:identifier                | identifiant                             | Identifiant alphanumérique unique du jeu de données concerné                                           | M        | 1           | multilingue                                            | //\*/gmd:identificationInfo/\*/gmd:citation/gmd:CI\_Citation/gmd:identifier/\*/gmd:code/\*                                                                                                                                                               |
| dcat:landingPage              | page d'acceuil                          | Informations relative(s) à la fiche de métadonnées HTML originale décrivant le jeu de données concerné | R        | 0-4         | URL multilingue                                        | [https://www.geo.be/catalog/details/ + //\*/gmd:fileIdentifier](https://www.geo.be/catalog/details/%20+%20/*/gmd:fileIdentifier)                                                                                                                         |
...
| dct:accessRights              | accessibilité                           | Informations relatives aux restrictions concernant l'utilisation du jeu de données                     | W        | 1           | dct:RightsStatement                                    |                                                                                                                                                                                                                                                          |
...
**Tableau 8 : classe foaf:Organization instanciée dans tout attribut**
...
**Tableau 9 : classe dcat:CatalogRecord instanciée dans tout attribut**
...
**Tableau 10 : classe locn:Address instanciée dans tout attribut**
...
**Tableau 11 : classe skos:Concept instanciée tout attribut**
...
**Tableau 12 : classe dct:PeriodOfTime instanciée dans tout attribut**
...
**Tableau 13 : classe dqv:QualityMeasurement se rapportant à la description d&#39;une ressource vectorielle**
...
**Tableau 14 : classe dqv:QualityMeasurement se rapportant à la description d&#39;une ressource matricielle**
...
**Tableau 18 : classe vcard:Organization instanciée dans tout attribut**
...
**Tableau 19 : classe vcard:Address instanciée dans tout attribut**
...
**Tableau 20 : classe dct: LicenseDocument instanciée dans tout attribut**
...
**Tableau 21 : classe rdf:Description instanciée dans tout attribut**
