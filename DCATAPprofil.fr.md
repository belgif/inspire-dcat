...
| URI                 | Nom                                     | Description                                                                                         | Exigence première instanciation (élément racine) | Exigence autre instanciation | Cardinalité | Domaine             | Source                                                                                                                                                                                                                                                       |
| ------------------- | --------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------- | ---------------------------- | ----------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| dct:identifier      | identifiant                             | Identifiant alphanumérique unique du catalogue                                                      | M                               | M                            | 1           | unilingue           | Pas de XPATH : sérialisation XML ?                                                                                                                                                                                                                          |
...
**Tableau 2 : Classe dcat:Dataset**

## C. dcat:DataService

### Instanciation de dcat:Dataservice
...
**Tableau 3 : classe dcat:DataService instanciée**
