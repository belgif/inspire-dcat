...
| dcat:contactPoint                                                                         | point de contact                       | Informations relatives aux modalités de prise de contact à propos du catalogue                      | R        | 0-1         | vcard:Organization                                                                       | //\*/ gmd:contact/ gmd:CI\_ResponsibleParty\[ gôleole/ gmd:CI\_RoleCode\[@codeListValue=’publisher’\]\]                                                          |
...
| dct:source    | Catalogrecord source                              | Informations relative(s) à la fiche de métadonnées originale décrivant le jeu de données          | O        | 0-1           | unilingue                                      | http://csw.geo.be/eng/csw?request=GetRecordById&service=CSW&version=2.0.2&elementSetName=full&outputSchema=http://www.isotc211.org/2005/gmd&id=+//\*/gmd:fileIdentifier                                                                                                                                                   |
...
| Catalog | dcat:theme | [https://vocab.belgif.be/auth/datatheme](https://vocab.belgif.be/auth/datatheme) | M |
...
| Dataset | dcat:theme | [https://vocab.belgif.be/auth/datatheme](https://vocab.belgif.be/auth/datatheme) | M |
...
| DataService | dcat:theme | [https://vocab.belgif.be/auth/datatheme](https://vocab.belgif.be/auth/datatheme) | M |
