...
| dcat:landingPage   | page d'acceuil                             | Informations relative(s) à la fiche de métadonnées HTML originale décrivant le jeu de données concerné                            | M        | 1           | multilingue                                      | https://www.geo.be/catalog/details/ + //*/gmd:fileIdentifier                                                                                                                                                  |
