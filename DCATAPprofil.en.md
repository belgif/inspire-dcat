...
| URI                 | Name                                 | Description                                                                               | Requirement first instantiation | Requirement in any other instantiation | Cardinality | Range              | Source                                                                                                                                                                                                                                                            |
| ------------------- | ------------------------------------ | ----------------------------------------------------------------------------------------- | ------------------------------- | -------------------------------------- | ----------- | ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| dcat:dataset        | dataset                              | Informatie over de dataset(s) referenced in the catalogue considered                      | R                               | W                                      | 1-n         | dcat:Dataset       | [if catalogue generated from a CSW --> getrecords with type = dataset <> if catalogue generated from wizard: a posteriori creation based on mentioned datasets](https://github.com/marielleadam/inspire-dcat/edit/main/DCATAPprofil.en.md#CSW)                    |
...
| foaf:homepage       | homepage                             | Human readable version of the catalogue considered                                        | R                               | R                                      | 0-1         | rdf:Description    | [No XPATH: https://www.geo.be/home (or homepage of catalogue specific to the institution if it's harvested)](https://www.geo.be/home)                                                                                                                             |
| dct:language        | language                             | Language(s) in which the catalog can be consulted                                         | M                               | O                                      | 4           | skos:Concept       | //\*/gmd:locale/gmd:PT_Locale/gmd:languageCode/gmd:LanguageCode/@codeListValue                                                                                                                                                                                    |
...
| dct:spatial         | spatial coverage                     | Description of the cover space of the resources included in the catalogue                 | R                               | O                                      | 1-n         | dct:Location       | //\*/gmd :identificationInfo/\*/gmd :extent/gmd :EX_Extent/gmd :geographicElement                                                                                                                                                                                 |
...
| dct:identifier      | identifier                           | Unique alphanumeric identifier of the catalogue                                           | M                               | M                                      | 1           | eentalig           | No XPATH: XML serialisation?                                                                                                                                                                                                                                      |
...
| dct:identifier                | identifier                           | Alphanumeric identifier unique to the dataset considered dataset                                                                                               | M                                                       | M                                                | 1           | multilingual            | //\*/gmd:identificationInfo/\*/gmd:citation/gmd:CI_Citation/gmd:identifier/\*/gmd:code/\*                                                                                                                                                                                                                                                                                                                     |
...
| dct:publisher                 | publisher                            | Information relating to the organization responsible for the availability of the dataset                                                                       | O                                                       | W                                                | 0-n         | foaf:Organization       | //\*/gmd:identificationInfo/\*/gmd:pointOfContact/gmd:CI_ResponsibleParty[gmd:role/gmd:CI_RoleCode[@codeListValue='publisher']]                                                                                                                                                                                                                                                                               |
...
| dcat:endpointURL              | URL of the service                   | URL of the service considered                                                                                         | M                                         | M                                                | 0-n         | URL                 | Te bekijken                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| dct:type                      | type of service                      | Information relating to the type of service                                                                           | R                                         | R                                                | 1           | skos:Concept        | //\*/gmd:identificationInfo/\*/srv:serviceType                                                                                                                                                                                                                                                                                                                                                                |
...
**Table 3 : dcat:Service class instantiated in the dcat:service attribute**
